...
# ACDS 16.0 211 win32 2016.07.30.13:23:32
# ----------------------------------------
...
# ----------------------------------------
# If hdmi_tx_pll is one of several IP cores in your
...
if ![info exists TOP_LEVEL_NAME] { 
  set TOP_LEVEL_NAME "hdmi_tx_pll"
}
...
alias com {
  echo "\[exec\] com"
  eval  vlog -v2k5 $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/hdmi_tx_pll.vo"
}
