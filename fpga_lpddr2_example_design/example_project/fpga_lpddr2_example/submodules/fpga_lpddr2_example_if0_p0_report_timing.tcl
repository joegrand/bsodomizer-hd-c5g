...
foreach inst $instances {
	...
	set fitter_run [fpga_lpddr2_example_if0_p0_get_io_interface_type [lindex [lindex $pins(q_groups) 0] 0]]
	if {$fitter_run == ""} {
	...
	foreach opc $opcs {
		...
		fpga_lpddr2_example_if0_p0_perform_ac_analyses  $opcs $opcname $inst $family scale_factors pins t summary IP		
