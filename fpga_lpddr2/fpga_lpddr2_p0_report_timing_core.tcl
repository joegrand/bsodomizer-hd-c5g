...
proc fpga_lpddr2_p0_perform_flexible_read_capture_timing_analysis {opcs opcname inst family scale_factors_name io_std interface_type max_package_skew dqs_phase period all_dq_pins pin_array_name timing_parameters_array_name summary_name MP_name IP_name board_name fpga_name} {
	...
	if {$IP(read_deskew_mode) == "dynamic"} {
		...
		set offset_from_90 [fpga_lpddr2_p0_get_acv_read_offset $period $dqs_phase $dqs_period]
		if {$IP(num_ranks) == 1} {
...
proc fpga_lpddr2_p0_perform_ac_analyses {opcs opcname inst family scale_factors_name pin_array_name timing_parameters_array_name summary_name IP_name} {
